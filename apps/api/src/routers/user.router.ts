...
export const userRouter = router({
  /** The 用户管理 table — every account with its role, disabled ones included. */
  ...
  /**
   * Role picker for the create/assign dialogs — names only, re-guarded for
   * user managers who hold no role.view (same pattern as dutyUserOptions).
   */
